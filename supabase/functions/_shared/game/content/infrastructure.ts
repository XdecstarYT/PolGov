...
export interface InfrastructureTemplate {
   ...
   */
  decayRate: number;
  /** ₡bn a month to hold the condition steady. */
  maintenanceCost: number;
  /** ₡bn to add one unit of capacity. */
  buildCost: number;
  /** Months to build. Most of these outlast the government that starts them. */
  buildMonths: number;
